  ...
  <thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td> Heal </td>
        <td> Ten </td>
        <td> 54K+ prot, +75 speed, 130%+ tenacity</td>
       </tr>
      <tr>
        <td> Actual </td>
        <td> Ten (3) </td>
        ...
        <td> Heal </td>
        <td> Ten </td>
        <td> 51K+ prot, +63 speed, 138%+ tenacity</td>
       </tr>
  </tbody>
</table>
  ...
  <thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>  </td>
        <td> Pot </td>
        <td> 70%+ pot, 7200+ off, 300+ speed </td>
       </tr>
      <tr>
        <td> Actual </td>
        <td> CC, CD </td>
        ...
        <td> Prot </td>
        <td> Off </td>
        <td> +100 speed, 6E square, cross, tri </td>
       </tr>
  </tbody>
</table>
  ...
  <thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td> Heal </td>
        <td> Prot </td>
        <td> 70k+ health, 61k+ prot, 240+ speed </td>
       </tr>
  </tbody>
</table>
  ...
  <thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td> Heal </td>
        <td> Pot </td>
        <td> 65K+ heal, 240+ speed, 7200+ dam, 52%+ ten</td>
       </tr>
  </tbody>
</table>
  ...
  <thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td> Prot </td>
        <td> Off </td>
        <td> 260+ speed, 4900+ dam, 67%+ CC, 51K+ heal </td>
       </tr>
  </tbody>
</table>
...
Tier four (IV) is a fleet battle using Han's Millennium Falcon and Wedge Antilles's X-wing. Since ship stats are based only on the mod level, then characters should be equipped with Mk VI-E mods.
  ...
  - Han Solo, Chewbacca, Wedge Antilles
  ...
  <thead>
    ...
    <tbody>
      ...
      <tr>
        <td> <a href="https://www.youtube.com/watch?v=EfHUxpwi5Jk&ab_channel=CubsFanHan">CubsFan Han</a></td>
        <td> CD, CC </td>
        <td> Heal, Off, Spd, CC </td>
        <td>  </td>
        <td>  </td>
        <td>  </td>
        <td>  </td>
        <td> 55k+ health, 240+ speed, 90%+ CC, 6500+ damage </td>
       </tr>
      <tr>
        <td> Actual </td>
        <td> CD, CC </td>
        ...
        <td> Heal </td>
        <td> Prot </td>
        <td> 43k+ health, 240+ speed, 100%+ CC, 4700+ damage </td>
       </tr>
  </tbody>
</table>
  ...
  <thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td> </td>
        <td> </td>
        <td> 80%+ pot, 250+ speed, 6500+ dam</td>
       </tr>
      <tr>
        <td> Actual </td>
        <td> Heal (2), Pot </td>
  ...
  <thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td> Prot </td>
        <td> Pot </td>
        <td> 280+ speed, 80%+ ten, 70%+ CC, 60K+ heal </td>
       </tr>
      <tr>
        <td> Actual </td>
        <td> CC, Heal, Ten </td>
  ...
  <thead>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>  </td>
        <td> Pot </td>
        <td> 100%+ pot, 7500+ off, 260+ speed </td>
       </tr>
      <tr>
        <td> Actual </td>
        <td> Off, Pot </td>
        ...
        <td> Heal </td>
        <td> Off </td>
        <td> 85%+ pot, 5700+ off, 200+ speed </td>
       </tr>
  </tbody>
</table>
